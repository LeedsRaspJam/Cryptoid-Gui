...
import type { FrontendRequestType, FrontendRequest, BackendResponse, CpuUsageResponse } from 'cryptoid-types'
...
export function sendWebsocketMessage(type: FrontendRequestType, data?: string): Promise<Record<string, any>> {
